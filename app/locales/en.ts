...
const en: LocaleType = {
  ...
  Error: {
    Unauthorized: isApp
     ...
     \\ 1️⃣ Configure your own API resources in [Settings](${SAAS_CHAT_UTM_URL})
  ...
  Auth: {
    ...
    Confirm: "Confirm",
    Later: "Later",
    SaasTips: "Use your own API resources",
    TopTips:
      "Configure your own OpenAI-compatible API key and endpoint to start chatting.",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        Title: "Use your own API resources",
        Label: "",
        SubTitle:
          "Configure an OpenAI-compatible API key and endpoint. No API key is bundled with this project.",
