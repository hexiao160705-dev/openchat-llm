export const OWNER = "hexiao160705-dev";
export const REPO = "openchat-llm";
export const REPO_URL = `https://github.com/${OWNER}/${REPO}`;
export const PLUGINS_REPO_URL = `https://github.com/topics/ai-chat-plugin`;
...
export const STORAGE_KEY = "openchat-llm";
